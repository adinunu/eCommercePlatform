...
public interface AuthFeign {
	...
	@PostMapping("/user/add/cashier")
	@Headers({"Content-Type:application/json;charset=utf-8"})
	Object addUserCashier(@RequestBody UserAddDTO udto);
	...
	@Headers({"Content-Type:application/x-www-form-urlencoded"})
	Object login(@RequestHeader("Authorization") String authorizationBasic, 
			@RequestParam("username") String username, 
	...
	@Headers({"Content-Type:application/x-www-form-urlencoded"})
	Object checkToken(@RequestHeader("Authorization") String authorizationBasic, 
